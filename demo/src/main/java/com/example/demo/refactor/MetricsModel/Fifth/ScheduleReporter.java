package com.example.demo.refactor.MetricsModel.Fifth;
...
public class ScheduleReporter {
    ...
    private Map<String, RequestStat> doStat(long startTimeInMillis, long endTimeInMillis) {
        ...
        while (segmentStartTimeMillis < endTimeInMillis) {
            ...
            Map<String, List<RequestInfo>> requestInfos = metricsStorage.getRequestInfos(segmentStartTimeMillis,
                    segmentEndTimeMillis);
